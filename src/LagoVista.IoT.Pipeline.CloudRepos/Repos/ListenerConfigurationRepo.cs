...
namespace LagoVista.IoT.Pipeline.CloudRepos.Repos
{
    public class ListenerConfigurationRepo : DocumentDBRepoBase<ListenerConfiguration>, IListenerConfigurationRepo
    {
        ...
        public ListenerConfigurationRepo(IPipelineAdminRepoSettings settings, ILogger logger) : base(settings.PipelineAdminDocDbStorage.Uri, settings.PipelineAdminDocDbStorage.AccessKey, settings.PipelineAdminDocDbStorage.ResourceName, logger)
        {
