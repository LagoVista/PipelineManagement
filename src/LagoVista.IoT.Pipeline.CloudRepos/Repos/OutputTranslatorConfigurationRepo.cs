...
namespace LagoVista.IoT.Pipeline.CloudRepos.Repos
{
    public class OutputTranslatorConfigurationRepo : DocumentDBRepoBase<OutputTranslatorConfiguration>, IOutputTranslatorConfigurationRepo
    {
        ...
        public OutputTranslatorConfigurationRepo(IPipelineAdminRepoSettings settings, ILogger logger) : base(settings.PipelineAdminDocDbStorage.Uri, settings.PipelineAdminDocDbStorage.AccessKey, settings.PipelineAdminDocDbStorage.ResourceName, logger)
        {
