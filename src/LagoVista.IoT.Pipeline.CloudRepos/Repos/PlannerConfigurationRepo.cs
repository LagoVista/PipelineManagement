...
namespace LagoVista.IoT.Pipeline.CloudRepos.Repos
{
    public class PlannerConfigurationRepo : DocumentDBRepoBase<PlannerConfiguration>, IPlannerConfigurationRepo
    {
        ...
        public PlannerConfigurationRepo(IPipelineAdminRepoSettings settings, ILogger logger) : base(settings.PipelineAdminDocDbStorage.Uri, settings.PipelineAdminDocDbStorage.AccessKey, settings.PipelineAdminDocDbStorage.ResourceName, logger)
        {
