...
// ContentHash: b8e70feacf11ffc2a0b02635336f171d2a53905f84b67a52877aa07cb60b5223
// IndexVersion: 2
// --- END CODE INDEX META ---
...
namespace LagoVista.IoT.Pipeline.CloudRepos.Repos
{
        ...
        ICustomPipelineConfigurationRepo
    {
        ...
        public CustomPipelineModuleConfigurationRepo(IPipelineAdminRepoSettings settings, IDocumentCloudCachedServices services) : 
        ...
        {
            return await base.QuerySummaryAsync<CustomModuleConfigurationSummary, CustomModuleConfiguration>(qry => qry.IsPublic == true || qry.OwnerOrganization.Id == orgId, qry => qry.Name, listRequest);
        }
